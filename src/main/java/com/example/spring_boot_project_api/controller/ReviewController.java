...
public class ReviewController {
  ...
  // Moderation: hide/show a review without deleting it (admin/staff only)
  @PreAuthorize("hasAnyRole('ADMIN', 'MANAGER', 'STAFF')")
  @PatchMapping("/{id}/visibility")
  public ReviewResponseDTO updateVisibility(@PathVariable Long id,
      @Valid @RequestBody ReviewVisibilityRequestDTO dto) {
    return reviewService.updateVisibility(id, dto);
  }
